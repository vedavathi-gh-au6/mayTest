...
companyApiControllers.addCompany=async (req,res)=>{
  try{
    ...
    companydetails.user = user._id;
    console.log(companydetails)
    //user.companydetails = [...user.companydetails, companydetails._id];
    const cdetails = await new Company(companydetails).save()
    ...
    res.redirect("/company")
      ...
      console.log(err);
      console.log("inside create company ERROR===")
